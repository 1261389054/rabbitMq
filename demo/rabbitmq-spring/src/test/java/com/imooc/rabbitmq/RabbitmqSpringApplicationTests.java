...
import com.imooc.rabbitmq.entity.Packaged;
...
public class RabbitmqSpringApplicationTests {
    ...
    public void testSendMessage(){
        ...
        rabbitTemplate.convertAndSend("topic001", "spring.amqp", message, new MessagePostProcessor() {
            ...
            public Message postProcessMessage(Message message) throws AmqpException {
                ...
                message.getMessageProperties().getHeaders().put("desc","修改后的描述");
    ...
    public void testSendMessage2() {
        ...
        rabbitTemplate.convertAndSend("topic001", "spring.amqp", "topic001 msg");
        rabbitTemplate.convertAndSend("topic002", "rabbit.abc", "topic002 msg");
    }
    ...
    public void testSendJavaMessage() throws Exception {
        ...
        //这里注意一定要修改contentType为 application/json
        messageProperties.setContentType("application/json");
        messageProperties.getHeaders().put("__TypeId__", "com.imooc.rabbitmq.entity.Order");
        Message message = new Message(json.getBytes(), messageProperties);
